...
import com.ericsson.edca.catalog.controller.CatalogMinioController;
...
@WebMvcTest(controllers = CatalogMinioController.class)//controller
public class CatalogMinioServiceTest {
    ...
    @Test
    void listMinioCatalogsTest() throws Exception {
        given(minioService.getFileCatalogs()).willReturn(catalogList);//service
        this.mockMvc.perform(get(BASE_URL + "/minio/catalog")).andDo(print()).andExpect(status().isOk())//controller
    ...
    void processCatalogTest() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post(BASE_URL + "/minio/catalog")//controller
    ...
    void returnFileCatalogByIdTest() throws Exception {
        ...
        given(minioService.getFileCatalogById(datatype, dataNotification)).willReturn(Optional.of(catalog));
        this.mockMvc
                .perform(get(BASE_URL + "/minio/catalogbyid").param("datatype", datatype).param("datanotification",
